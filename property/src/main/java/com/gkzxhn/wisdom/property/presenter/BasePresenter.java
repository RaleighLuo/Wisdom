...
import com.gkzxhn.wisdom.property.async.AsynHelper;
...
import com.gkzxhn.wisdom.property.view.IBaseView;
...
public class BasePresenter<M extends IBaseModel,V extends IBaseView> {
    ...
    protected void unauthorized(){//login has expired
        ...
        if(mContext!=null&&!mModel.getSharedPreferences().getBoolean(Constants.USER_IS_UNAUTHORIZED,false)) {
