...
import com.gkzxhn.wisdom.property.adapter.TopicCommentDetailAdapter;
import com.gkzxhn.wisdom.property.common.Constants;
import com.gkzxhn.wisdom.property.customview.CommentDialog;
import com.gkzxhn.wisdom.property.customview.CommentShowDialog;
...
import com.gkzxhn.wisdom.property.presenter.TopicCommentDetailPresenter;
import com.gkzxhn.wisdom.property.util.Utils;
import com.gkzxhn.wisdom.property.view.ITopicCommentDetailView;
...
public class TopicCommentDetailActivity extends SuperActivity implements CusSwipeRefreshLayout.OnRefreshListener,ITopicCommentDetailView {
    ...
    public void update(TopicCommentDetailEntity entity,List<TopicReplayEntity> mDatas) {
        if(entity!=null) {
            ...
            //现在头像
            ImageLoader.getInstance().displayImage(entity.getPortrait(), ivPortrait, Utils.getOptions(R.mipmap.portrait));
